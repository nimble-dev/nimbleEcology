...
We expect to add N-mixture models in the future.
...
{
hist(as.data.frame(samples)$psi, border = "red", main = "psi")
hist(as.data.frame(samples_new)$psi, border = "blue", add = TRUE)
}

{
hist(as.data.frame(samples)$p, border = "red", main = "p")
hist(as.data.frame(samples_new)$p, border = "blue", add = TRUE)
}
